...
// City/Area routes (Public)
router.get("/cities", AuthController.getCities);
router.get("/cities/:cityId/areas", AuthController.getAreasByCity);
router.get("/cities/search", AuthController.searchCities);
router.post("/cities/check-availability", AuthController.checkAvailability);
